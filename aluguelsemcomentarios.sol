...
0xC6646bC5D0e87c45040113ff87D2d4781B6152CC
...
contract Aluguel {
    ...
    */
    ...
    function receberPagamento() public payable {
        /* Incluido apenas essa linha, caso o owner seja diferente ira dar um require e imprimir a msg */
        require(msg.sender == proprietario, "Pagamento recusado, somente o locatario pode realizar o pagamento");
